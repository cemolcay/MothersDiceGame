...
enum DFAM: Int, PatchPoint {
    ...
    static let `default`: DFAM = .trigger
    static let colCount: Int = 3
...
enum Mother32: Int, PatchPoint {
    ...
    static var `default`: Mother32 = .extAudio
    static let colCount: Int = 4
    static let rowCount: Int = 8
...
enum Subharmonicon: Int, PatchPoint {
    ...
    static var `default`: Subharmonicon = .vco1
    static let colCount: Int = 4
    static let rowCount: Int = 8
